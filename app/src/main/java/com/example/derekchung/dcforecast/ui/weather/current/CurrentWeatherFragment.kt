...
import com.example.derekchung.dcforecast.R
import com.example.derekchung.dcforecast.internal.glide.GlideApp
import com.example.derekchung.dcforecast.ui.base.ScopedFragment
...
class CurrentWeatherFragment : ScopedFragment(), KodeinAware {
  ...
  private fun bindUI() = launch {
    ...
    currentWeather.observe(this@CurrentWeatherFragment, Observer {
      ...
      updateLocation("North Vancouver")
      updateDateToToday()
